...
export const bn: TranslationKeys = {
  ...
  hero: {
    ...
    titleHighlight: "গড়া",
    subtitle:
      "একটি চমৎকার বিবাহ বায়োডেটা তৈরি করুন যা পরিবারগুলো মনে রাখবে। 14 হাতে তৈরি টেমপ্লেটস থেকে বেছে নিন, বিবরণ পূরণ করুন, এবং প্রিন্ট-রেডী PDF ডাউনলোড করুন — কয়েক মিনিটে।",
